...
class TemplateAnalysisPage(QWidget):
    ...
    def showEvent(self, event: QShowEvent):
        ...
        if (index := self._extracted_log_list_model.get_row(self._select_log_id)) >= 0:
            ...
            self._template_avg_time_card.clear()
    ...
    def _init_card(self):
        ...
        self._template_avg_time_card = TemplateAvgTimeCard(parent=self)
        self._card_layout.addWidget(self._template_avg_time_card)
    ...
    def _on_log_selected(self, index: int):
        ...
        self._template_avg_time_card.setTable(
            structured_table_name,
            templates_table_name,
        )
