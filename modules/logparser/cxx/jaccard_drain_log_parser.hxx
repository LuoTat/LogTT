...
class JaccardDrainLogParser: BaseLogParser
{
public:
    JaccardDrainLogParser() = default;
    ...
    JaccardDrainLogParser(const JaccardDrainLogParser&)            = delete;
    JaccardDrainLogParser& operator=(const JaccardDrainLogParser&) = delete;

    JaccardDrainLogParser(JaccardDrainLogParser&&) noexcept            = default;
